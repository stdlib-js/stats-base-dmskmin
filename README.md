...
```javascript
dmskmin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmskmin@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dmskmin/tags). For example,

```javascript
dmskmin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmskmin@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dmskmin = require( 'path/to/vendor/umd/stats-base-dmskmin/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dmskmin/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-base-dmskmin/actions/workflows/test.yml?query=branch:v0.1.1
